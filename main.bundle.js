...
module.exports = "<div class=\"card\">\n  <div class=\"card-header\">\n    Add new FAQ\n  </div>\n  <div class=\"card-block\">\n    <form name=\"mainForm\" (submit)=\"addQuestion()\" action=\"\">\n      <div class=\"form-group\">\n        <label for=\"text\">Question</label>\n        <input type=\"text\" id=\"questionBox\" required minlength=\"4\" name=\"text\" [(ngModel)]=\"text\" class=\"form-control\">\n        <div *ngIf=\"text.errors.required\" class=\"error-message\">\n          Name is requried and must be atleast 4 digits\n        </div>\n      </div>\n      <div class=\"form-group\">\n        <label for=\"text\">Answer</label>\n        <input type=\"text\" id=\"answerBox\" required minlength=\"4\" name=\"answer\" [(ngModel)]=\"answer\" class=\"form-control\">\n      </div>\n      <input type=\"submit\" class=\"btn btn-primary\" value=\"submit\">\n    </form>\n  </div>\n</div>"
...
var QuestionListComponent = /** @class */ (function () {
    ...
    QuestionListComponent.prototype.ngOnInit = function () {
        return this.questions = this.dataService.getQuestions();
    };
...
module.exports = "<div class=\"question\">\n  <div class=\"card\">\n    <div class=\"card-header\">\n      {{ question.text }} <a href=\"#\" class=\"btn btn-link\" (click)=\"question.hide = !question.hide\">Show answer</a> | \n      <a href=\"#\" (click)=\"removeQuestion(question)\" class=\"btn btn-link text-danger\">Remove</a>\n    </div>\n    <div class=\"card-block\" [hidden]=\"question.hide\">\n      <p class=\"card-text\">\n        {{ question.answer }}\n      </p>\n    </div>\n  </div>\n  <hr>\n</div>"
